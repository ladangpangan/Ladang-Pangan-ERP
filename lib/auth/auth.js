...
export function getAuth() {
  if (!_auth) {
    ...
    _auth = betterAuth({
      ...
      // Resolve the canonical base URL from env (never hardcode the domain). In Emergent,
      // production usually injects APP_URL; this silences the "Base URL is not set" warning.
      // If none resolve, better-auth safely derives the origin from the incoming request.
      baseURL:
