...
function aggregate(sqlite, { from = null, to = null } = {}) {
...
function netIncome(sqlite, { from = null, to = null } = {}) {
  const agg = aggregate(sqlite, { from, to });
...
export function overview(sqlite) {
  ...
  const ni = netIncome(sqlite, { from: ytdFrom, to: now });
  const niM = netIncome(sqlite, { from: monthFrom, to: now });
